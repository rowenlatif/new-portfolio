...
export default function Home() {
  return (
    <main className="flex-1 flex flex-col">
      ...
      <section
        id="featured-works"
        className="relative z-10 isolate overflow-hidden bg-white border-t border-white/70 rounded-t-[2rem] rounded-b-[2rem] shadow-[0_-20px_40px_-20px_rgba(0,0,0,0.2),0_20px_40px_-20px_rgba(0,0,0,0.2)] px-10 pt-14 pb-24 scroll-mt-24"
      >
      ...
      <div className="relative h-[200vh] -mt-[100vh]">
        <section className="sticky top-0 z-0 h-screen overflow-hidden bg-olive px-10 pt-28 text-white">
